...
```
Bandar khayega, kutta toh sirf dekh raha hai
```

```
Kyunki wo dono shadi-shuda (couple) the! (Single log hi mare)
```

```
Kaanch (Glass) se. (Greenhouse plants ugane ke liye hota hai!).
```

```
Sabse pehle machis ki teeli jalaenge!
```

```
9 bakriyan. (Sawaal me hi jawab hai—9 ko chhodkar sab mar gayin!).
```
